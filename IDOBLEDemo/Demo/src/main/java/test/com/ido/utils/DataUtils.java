...
public class DataUtils extends CommonPreferences {
    ...
    private static final String KEY_WATCH_PLATE_FILE_PATH = "KEY_WATCH_PLATE_FILE_PATH";
    ...
    public String getWatchPlateFilePath(){
        return getValue(KEY_WATCH_PLATE_FILE_PATH,"");
    }

    public void saveWatchPlateFilePath(String path){
        setValue(KEY_WATCH_PLATE_FILE_PATH, path);
    }
}
