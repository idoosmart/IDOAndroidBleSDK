...
//                btnOk.setVisibility(View.VISIBLE);
    ...
    private DeviceResponseCommonCallBack.ICallBack deviceResponsCallBack = new DeviceResponseCommonCallBack.ICallBack() {
        @Override
        public void onCallBackSysEvt(int evt_base, int evt_type, int error, int value) {

        }

        @Override
        public void onCallBackJsonData(byte[] jsonData, int evt_type, int err) {
//            if (evt_type == ProtocolEvt.GET_MTU_INFO){
//                closeProgressDialog();
//                String jsonString = ByteDataConvertUtil.bytetoString(jsonData);
//                if (!TextUtils.isEmpty(jsonString)){
//                    mtuInfo = GsonUtil.analysisJsonToObject(jsonString, MtuInfo.class);
//                }
//
//                gotoNextPage();
//            }
